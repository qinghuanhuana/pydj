...
class LoginRegister(unittest.TestCase):
    def setUp(self):
        ...
        self.openexecle = openExecle(r'.\Data\testcase.xlsx')
        self.headers = {
    ...
    def test_zhuce_mobile(self):
        r = requests.post(self.openexecle.sheet.row(1)[3].value,data=self.openexecle.sheet.row(1)[6].value,headers=self.headers,verify=False)
        self.result = r.json()
    ...
    def test_weizhuce_mobile(self):
        r = requests.post(self.openexecle.sheet.row(2)[3].value,data=self.openexecle.sheet.row(2)[6].value,headers=self.headers,verify=False)
        self.result = r.json()
    ...
    def test_yzmerr_photo(self):
        r = requests.post(self.openexecle.sheet.row(3)[3].value,data=self.openexecle.sheet.row(3)[6].value,headers=self.headers,verify=False)
        self.result = r.json()
    ...
    def test_yzmtrue_phone(self):
        r = requests.post(self.openexecle.sheet.row(4)[3].value,data=self.openexecle.sheet.row(4)[6].value,headers=self.headers,verify=False)
        self.result = r.json()
    ...
    def test_yzmerr_phone(self):
        r = requests.post(self.openexecle.sheet.row(5)[3].value,data=self.openexecle.sheet.row(5)[6].value,headers=self.headers,verify=False)
        self.result = r.json()
    ...
    def test_reset_password(self):
        r = requests.post(self.openexecle.sheet.row(6)[3].value,data=self.openexecle.sheet.row(6)[6].value,headers=self.headers,verify=False)
        self.result = r.json()
    ...
    def test_registerBy_phone(self):
        r = requests.post(self.openexecle.sheet.row(7)[3].value,data=self.openexecle.sheet.row(7)[6].value,headers=self.headers,verify=False)
        self.result = r.json()
    ...
    def test_yzmRegerr_phone(self):
        r = requests.post(self.openexecle.sheet.row(8)[3].value,data=self.openexecle.sheet.row(8)[6].value,headers=self.headers,verify=False)
        self.result = r.json()
    ...
    def test_registerNo_phone(self):
        r = requests.post(self.openexecle.sheet.row(9)[3].value,data=self.openexecle.sheet.row(9)[6].value,headers=self.headers,verify=False)
        self.result = r.json()
    ...
    def test_register_user(self):
        ...
        from denglu.common.read_token import readtoken
